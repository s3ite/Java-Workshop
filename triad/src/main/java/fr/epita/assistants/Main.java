...
public class Main {
    public static void main(String[] args) {
        ...
        final WriteGettersAndConstructorForMe writeGettersAndConstructorForMe = new WriteGettersAndConstructorForMe("name", "firstName", "lastName", "random", "anotherOne", "anotherOne2", "anotherOne3", "xyz", 1, 2.0, 3.0f, true, false);
